...
import 'package:cognos/struct_hive/user_hive.dart';
...
class _UserPageState extends State<UserPage> {
  ...
  /*void initHive() async{
    ...
    await Hive.openBox<PersonModel>('userDetails');
  }*/

  void _onFormSubmit() {
    Box<PersonModel> contactsBox = Hive.box<PersonModel>('userDetails');
    contactsBox.add(PersonModel(currentUserId, nameCon.text, emailCon.text, phoneCon.text, prourl));
  }
